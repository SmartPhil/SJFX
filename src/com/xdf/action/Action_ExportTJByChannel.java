...
public class Action_ExportTJByChannel extends ActionSupport {
	...
	public String exportTj() throws IOException{
		...
		HSSFCell cell10 = row2.createCell(7);
		...
		for (int i = 0; i < dataCollaList.size(); i++) {
			 if(i == 0){
				 ...
				 HSSFCell dataCell_Name1 = dataRow2.createCell(1);
				 dataCell_Name1.setCellValue(dataCollaList.get(i).getName());
				 HSSFCell dataCell_CurtWeek1 = dataRow2.createCell(2);
				 dataCell_CurtWeek1.setCellValue(dataCollaList.get(i).getCurtWeekCount());
				 HSSFCell dataCell_LastWeek1 = dataRow2.createCell(3);
				 dataCell_LastWeek1.setCellValue(dataCollaList.get(i).getLastWeekCount());
				 HSSFCell dataCell_WeekRisePer1 = dataRow2.createCell(4);
				 dataCell_WeekRisePer1.setCellValue(dataCollaList.get(i).getWeekRisePercent());
				 HSSFCell dataCell_CurtMonth1 = dataRow2.createCell(5);
				 dataCell_CurtMonth1.setCellValue(dataCollaList.get(i).getCurtMonthCount());
				 HSSFCell dataCell_LastMonth1 = dataRow2.createCell(6);
				 dataCell_LastMonth1.setCellValue(dataCollaList.get(i).getLastMonthCount());
				 HSSFCell dataCell_CurtQuartor1 = dataRow2.createCell(7);
				 dataCell_CurtQuartor1.setCellValue(dataCollaList.get(i).getCurtQuarter());
			}
		}
		
		//未完待续 还有网络合作跟市场推荐数据没有加上……
		//………………………………………………………………………………
